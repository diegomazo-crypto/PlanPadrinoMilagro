...
function vistaPublica(empresa) {
  return {
    ...
    informe: empresa.informe ? { generado: empresa.informe.generado, nombre: empresa.informe.nombre, correo: empresa.informe.correo ? { para: empresa.informe.correo.para, estado: empresa.informe.correo.estado, fecha: empresa.informe.correo.fecha } : null, error: empresa.informe.error } : null,
    diagnostico: {
